<div className="min-h-screen bg-white flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
  <div className="w-full max-w-4xl text-center">
    ...
    {/* Social Icons */}
    <div className="grid grid-cols-2 sm:flex sm:flex-wrap sm:justify-center gap-6 sm:gap-10 lg:gap-16">
          ...
          >
            ...
            >
              <div className="relative mb-3">
                <div
                  className={`w-14 h-14 sm:w-16 sm:h-16 lg:w-20 lg:h-20 mx-auto rounded-full ${platform.color}
